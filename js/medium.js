/*
The Medium RSS to JSON formater is written in Javascript. Kudos to Jason Mathew for the wonderful article at
...
$(function () {
  ...
  // Linking in the content location
  var $content = $('#medium-blog');
  var data = {
    rss_url: 'https://medium.com/feed/@DevduttShenoi'
  };
